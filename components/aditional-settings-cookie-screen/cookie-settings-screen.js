...
const CookieSettings = () => {
  ...
  return (
    <motion.div
      ...
      className="p-2 z-[100] fixed left-0 top-0 w-full h-full bg-thirdGradient overflow-auto"
    >
      <div className="flex flex-col gap-5">
        <div className="flex flex-row justify-end">
          <AiOutlineClose
            ...
            className="mt-[5vh] mr-[5vw] fill-white hover:cursor-pointer"
            size={30}
          />
        </div>
        <div className="mt-10">
          <h2 className="text-center p-2 text-3xl sm:text-7xl text-white">
            Setari cookie
          </h2>
        </div>
        <div className="">
          <p className="text-white text-sm sm:text-lg p-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          <div className="flex flex-col gap-2 items-center justify-around rounded-lg bg-firstGradient p-2">
            <div>
              <h2 className="text-3xl font-bold text-black">Esentiale</h2>
            </div>

            <div>
              <MdSettings className="w-[50px] h-[50px] fill-black" />
            </div>
        ...
        <div className="flex flex-row">
          <p className="p-2 text-4xl text-white">Informatii suplimentare</p>
        </div>
        <div className="flex flex-row">
